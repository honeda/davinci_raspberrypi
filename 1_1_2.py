...
# Define a functijon to set up colors
...
def setColor(color):
    ...
    # these three lines are used for analyzing the col cariables
    # assign the first two values of the hexadecimal to R, the middle two assigned to G
    # assign the last two values to B,
    # please refer to the shift operation of the hexadecimal for details.
